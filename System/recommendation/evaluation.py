...
def evaluate_recommendations(
    ...
    """Evaluate recommendation quality with metrics for genre, language, and emerging artist exposure."""
    ...
    # Prepare metadata merge, prioritizing test_interactions columns
    ...
    for k in k_values:
        ...
        for user_id in test_by_user:
            ...
            tier_weights = {
                ...
                'rising_established': 0.6, 'mid_tier': 0.4, 'established': 0.2,'established_trending': 0.2,'established_legacy': 0.2
            }
...
class RecommendationEvaluator:
    def __init__(
        ...
        print(self.k_values)
        if not item_ids or len(item_features.shape) < 1 or len(item_ids) != item_features.shape[0]:
